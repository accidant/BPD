...
if($loggedin) {
	...
	if(isanyadmin($userID)) $admin=' <a class="red_button_sml" href="admin/admincenter.php" target="_blank">'.$_language->module['admin'].'</a>';
	else $admin='';
	if(isclanmember($userID) or iscashadmin($userID)) $cashbox=' <a class="red_button_sml" href="index.php?site=cash_box">'.$_language->module['cash-box'].'</a>';
	else $cashbox='';
